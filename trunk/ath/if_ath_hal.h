...
__hal_wrapper HAL_BOOL ath_hal_settpc(struct ath_hal* ah, u_int32_t v)
	IMPLEMENTATION({ return ((ath_hal_setcapability(ah, HAL_CAP_TPC, 1, v, NULL))); })
__hal_wrapper HAL_BOOL ath_hal_gettsfadjust(struct ath_hal* ah)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_TSF_ADJUST, 1, NULL) == HAL_OK)); })
__hal_wrapper HAL_BOOL ath_hal_hasrfsilent(struct ath_hal* ah)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_RFSILENT, 0, NULL) == HAL_OK)); })
__hal_wrapper HAL_BOOL ath_hal_quarterrate_chansupported(struct ath_hal* ah)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_CHAN_QUARTERRATE, 0, NULL) == HAL_OK)); })
__hal_wrapper HAL_BOOL ath_hal_xrsupported(struct ath_hal* ah)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_XR, 0, NULL) == HAL_OK)); })
__hal_wrapper HAL_BOOL ath_hal_getmaxtxpow(struct ath_hal* ah, u_int32_t* destination)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_TXPOW, 2, destination) == HAL_OK)); })
__hal_wrapper HAL_BOOL ath_hal_gettkipmic(struct ath_hal* ah)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_TKIP_MIC, 1, NULL) == HAL_OK)); })
__hal_wrapper HAL_BOOL ath_hal_hasbssidmask(struct ath_hal* ah)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_BSSIDMASK, 0, NULL) == HAL_OK)); })
__hal_wrapper HAL_BOOL ath_hal_settkipmic(struct ath_hal* ah, u_int32_t v)
	IMPLEMENTATION({ return ((ath_hal_setcapability(ah, HAL_CAP_TKIP_MIC, 1, v, NULL))); })
__hal_wrapper HAL_BOOL ath_hal_hasdiversity(struct ath_hal* ah)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_DIVERSITY, 0, NULL) == HAL_OK)); })
__hal_wrapper HAL_BOOL ath_hal_getregdomain(struct ath_hal* ah, u_int32_t* destination)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_REG_DMN, 0, destination))); })
__hal_wrapper HAL_BOOL ath_hal_setdiversity(struct ath_hal* ah, int v)
	IMPLEMENTATION({ return ((ath_hal_setcapability(ah, HAL_CAP_DIVERSITY, 1, v, NULL))); })
__hal_wrapper HAL_BOOL ath_hal_fastframesupported(struct ath_hal* ah)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_FASTFRAME, 0, NULL) == HAL_OK)); })
__hal_wrapper HAL_BOOL ath_hal_gettpscale(struct ath_hal* ah, u_int32_t* destination)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_TXPOW, 3, destination) == HAL_OK)); })
__hal_wrapper HAL_BOOL ath_hal_settkipsplit(struct ath_hal* ah, int v)
	IMPLEMENTATION({ return ((ath_hal_setcapability(ah, HAL_CAP_TKIP_SPLIT, 1, v, NULL))); })
__hal_wrapper HAL_BOOL ath_hal_getnumtxqueues(struct ath_hal* ah, u_int32_t* destination)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_NUM_TXQUEUES, 0, destination) == HAL_OK)); })
__hal_wrapper HAL_BOOL ath_hal_compressionsupported(struct ath_hal* ah)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_COMPRESSION, 0, NULL) == HAL_OK)); })
__hal_wrapper HAL_BOOL ath_hal_burstsupported(struct ath_hal* ah)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_BURST, 0, NULL) == HAL_OK)); })
__hal_wrapper HAL_BOOL ath_hal_gettpc(struct ath_hal* ah)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_TPC, 1, NULL) == HAL_OK)); })
__hal_wrapper HAL_BOOL ath_hal_gettkipsplit(struct ath_hal* ah)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_TKIP_SPLIT, 1, NULL) == HAL_OK)); })
__hal_wrapper HAL_BOOL ath_hal_hastkipsplit(struct ath_hal* ah)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_TKIP_SPLIT, 0, NULL) == HAL_OK)); })
__hal_wrapper HAL_BOOL ath_hal_halfrate_chansupported(struct ath_hal* ah)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_CHAN_HALFRATE, 0, NULL) == HAL_OK)); })
__hal_wrapper HAL_BOOL ath_hal_getdiversity(struct ath_hal* ah)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_DIVERSITY, 1, NULL) == HAL_OK)); })
__hal_wrapper HAL_BOOL ath_hal_hwphycounters(struct ath_hal* ah)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_PHYCOUNTERS, 0, NULL) == HAL_OK)); })
__hal_wrapper HAL_BOOL ath_hal_hastsfadjust(struct ath_hal* ah)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_TSF_ADJUST, 0, NULL) == HAL_OK)); })
__hal_wrapper HAL_BOOL ath_hal_settpscale(struct ath_hal* ah, u_int32_t v)
	IMPLEMENTATION({ return ((ath_hal_setcapability(ah, HAL_CAP_TXPOW, 3, v, NULL))); })
...
__hal_wrapper HAL_BOOL ath_hal_settsfadjust(struct ath_hal* ah, u_int32_t v)
	IMPLEMENTATION({ return ((ath_hal_setcapability(ah, HAL_CAP_TSF_ADJUST, 1, v, NULL))); })
__hal_wrapper HAL_BOOL ath_hal_hastxpowlimit(struct ath_hal* ah)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_TXPOW, 0, NULL) == HAL_OK)); })
__hal_wrapper HAL_BOOL ath_hal_setrfsilent(struct ath_hal* ah, u_int32_t v)
	IMPLEMENTATION({ return ((ath_hal_setcapability(ah, HAL_CAP_RFSILENT, 1, v, NULL))); })
...
__hal_wrapper HAL_BOOL ath_hal_hasmcastkeysearch(struct ath_hal* ah)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_MCAST_KEYSRCH, 0, NULL) == HAL_OK)); })
__hal_wrapper HAL_BOOL ath_hal_turboagsupported(struct ath_hal* ah, int countrycode)
	IMPLEMENTATION({ return ((ath_hal_getwirelessmodes(ah, countrycode) & (HAL_MODE_108G|HAL_MODE_TURBO))); })
__hal_wrapper HAL_BOOL ath_hal_hasveol(struct ath_hal* ah)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_VEOL, 0, NULL) == HAL_OK)); })
__hal_wrapper HAL_BOOL ath_hal_wmetkipmic(struct ath_hal* ah)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_WME_TKIPMIC, 0, NULL) == HAL_OK)); })
...
__hal_wrapper HAL_BOOL ath_hal_getmcastkeysearch(struct ath_hal* ah)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_MCAST_KEYSRCH, 1, NULL) == HAL_OK)); })
__hal_wrapper HAL_BOOL ath_hal_ciphersupported(struct ath_hal* ah, u_int32_t cipher)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_CIPHER, cipher, NULL) == HAL_OK)); })
__hal_wrapper HAL_BOOL ath_hal_gettxpowlimit(struct ath_hal* ah, u_int32_t* destination)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_TXPOW, 1, destination) == HAL_OK)); })
__hal_wrapper HAL_BOOL ath_hal_hastkipmic(struct ath_hal* ah)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_TKIP_MIC, 0, NULL) == HAL_OK)); })
__hal_wrapper HAL_BOOL ath_hal_hastpc(struct ath_hal* ah)
	IMPLEMENTATION({ return ((ath_hal_getcapability(ah, HAL_CAP_TPC, 0, NULL) == HAL_OK)); })
__hal_wrapper HAL_BOOL ath_hal_getcountrycode(struct ath_hal* ah, u_int32_t* destination)
	IMPLEMENTATION({ return (((*(destination) = ah->ah_countryCode), AH_TRUE)); })
