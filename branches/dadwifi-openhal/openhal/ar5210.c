...
HAL_BOOL
ar5k_ar5210_reset(struct ath_hal *hal, u_int32_t op_mode, HAL_CHANNEL *channel,
...
ar5k_ar5210_set_rx_signal(struct ath_hal *hal, HAL_CHANNEL *channel)
{
...
void /*Unimplemented*/
ar5k_ar5210_proc_mib_event(struct ath_hal *hal) 
{
	AR5K_TRACE;
	return;
}
